...
PNAME="k8s_manager_server"

if [ x"$1" == "xtest" ]; then
    PNAME="k8s_manager_server-sandbox"
...
sed -i  's/__BUILD_VERSION__/'${VERSION}'/'  cmd/main.go
...
#推送的地域，分别为华北、华东、华南
REGIONS="beijingbd oversea oversea-sg oversea-va oversea-fra"
